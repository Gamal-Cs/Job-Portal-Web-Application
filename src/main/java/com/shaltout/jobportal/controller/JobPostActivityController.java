...
import com.shaltout.jobportal.entity.*;
import com.shaltout.jobportal.services.JobPostActivityService;
import com.shaltout.jobportal.services.JobSeekerApplyService;
import com.shaltout.jobportal.services.JobSeekerSaveService;
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities()
                ...
                List<JobSeekerSave> jobSeekerSaveList = jobSeekerSaveService
                        .getCandidateJob((JobSeekerProfile) currentUserProfile);
